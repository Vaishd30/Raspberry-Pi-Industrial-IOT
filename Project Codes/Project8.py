...
def measure(channel):
    ...
    try:
        for _ in range(5):
            ...
            print(f'Date={date} Time={time} Temp={Temperature:0.1f}*C Humidity={Humidity:0.1f}% Pressure={Pressure} Pa Altitude={Altitude} m SeaLevelPressure={SeaLevelPressure} Pa AmbientLight={AmbientLight} Lux DewPoint={DewPoint}*C Air Density={AirDensity} kg/cubicmeter')
